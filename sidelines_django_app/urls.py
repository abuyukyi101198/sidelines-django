...
urlpatterns = [
    ...
    path('friend-requests/<str:friend_request_type>/', FriendRequestView.as_view(), name='friend_request-list'),
    path('friend-requests/<int:friend_request_id>/<str:action>/', FriendRequestView.as_view(), name='friend_request_action'),
